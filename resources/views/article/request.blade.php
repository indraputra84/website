...
<html lang="zxx" class="no-js">
	<head>
		...
		<meta charset="UTF-8">
		<!-- Site Title -->
		<title>Ini Game Cak | Request</title>
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="hero-nav-area">
								<h1 class="text-white">Request</h1>
								<p class="text-white link-nav"><a href="index.html">Home </a>  <span class="lnr lnr-arrow-right"></span><a href="contact.html">Request </a></p>
							</div>
						</div>
					</div>
				</div>
			...
			<section class="contact-page-area pt-50 pb-120">
				<div class="container">
					<div class="row contact-wrap">
						...
						<div class="col-lg-9">
							<form class="form-area contact-form text-right" id="myForm" action="{{ route('createrequest') }}" method="post">
								{{ csrf_field() }}
								...
								<div class="row">
									<div class="col-lg-6">
										...
										<input name="category" placeholder="Enter category" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter category'" class="common-input mb-20 form-control" required="" type="text">
									</div>
									<div class="col-lg-6">
										<textarea name="req" class="common-textarea form-control"  placeholder="Enter Messege" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Request'" required=""></textarea>
									</div>
									<div class="col-lg-12">
