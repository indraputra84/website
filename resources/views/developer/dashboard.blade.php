    ...
    <div class="page-container">
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            <li><a href="{{ route('developer.home') }}"><i class="fas fa-home"></i></i><span>dashboard</span></a></li>
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="far fa-plus-square"></i></i><span>Create</span></a>
                                <ul class="collapse">
                                    <li><a href="fontawesome.html">fontawesome icons</a></li>
                                    <li><a href="{{ route('admin.createarticle') }}">Create article</a></li>
                                    <li><a href="{{ route('admin.createrp') }}">Create random pick</a></li>
                            ...
                            <li>
                                <a href="javascript:void(0)" aria-expanded="true"><i class="fa fa-table"></i>
                                    <span>Tables</span></a>
                                <ul class="collapse">
                                    <li><a href="table-basic.html">Table coment</a></li>
                                    <li>
                                        <a href="{{ route('admin.contact') }}">Table Contact <span class="badge badge-edit">{{ $contactcount }}</span></a>
                                    </li>
                                    <li>
                                        <a href="{{ route('admin.request') }}">Table Request <span class="badge badge-edit">{{ $requestcount }}</a>
                                    </li>
                                    <li><a href="{{ route('admin.article') }}">Table article</a></li>
                                    <li><a href="{{ route('admin.rp') }}">Table Random Pick</a></li>
                                    <li><a href="{{ route('admin.category') }}">Table Category</a></li>
                                </ul>
                            </li>
                            <li>
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item" href="{{ route('admin.setting', Auth::user()->id) }}">Settings</a>
        ...
        <footer>
            <div class="footer-area">
                <p>Powered By Colorlib Edit By Indra</p>
            </div>
        </footer>
        <!-- footer area end-->
    </div>
